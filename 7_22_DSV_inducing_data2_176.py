...
train_x = receiver_position[150:,:] # cbrssdr1-honors-comp: 409, 359, 309, 189, (296)
train_y = RSS_value[150:,:]
test_x = receiver_position[0:150,:]
test_y = RSS_value[0:150,:]
...
num_inducing_choice = [i for i in range(math.floor(train_x.size(0) / 4),train_x.size(0)-1, 5)] # time: 27
