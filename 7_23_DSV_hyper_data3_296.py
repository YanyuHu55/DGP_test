...
test_x = receiver_position[76:,:] # cbrssdr1-honors-comp: 409, 359, 309, 189, (296)
test_y = RSS_value[76:,:]
train_x = receiver_position[0:76,:]
train_y = RSS_value[0:76,:]
...
hiden_lengthscale_choice = [0.08]
# hiden_lengthscale_choice_2 = [0.25]
hiden_outputscale_choise = [0.4] # [-3.0, -2.0, -1.0] [-0.1, -0.01, 0.1]
last_lengthscale_choice  = [0.38] # last_lengthscale_choice  = [-0.1, 0.1, 0.01, -0.01]
last_outputscale_choise  = [0.7] # -1.5, -1.75, 0.01
...
# hiden_lengthscale_choice = [0.05, 0.1, 0.15, 0.2, 0.25]
# # hiden_lengthscale_choice_2 = [0.25]
# hiden_outputscale_choise = [0.1, 0.4, 0.7] # [-3.0, -2.0, -1.0] [-0.1, -0.01, 0.1]
# last_lengthscale_choice  = [0.1, 0.4, 0.7] # last_lengthscale_choice  = [-0.1, 0.1, 0.01, -0.01]
# last_outputscale_choise  = [0.1, 0.4, 0.7] # -1.5, -1.75, 0.01
# likelihood_noise_range   = [0.01]


num_inducing_choice = [51]
