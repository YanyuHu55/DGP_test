...
train_x = receiver_position[200:,:] # cbrssdr1-honors-comp: 409, 359, 309, 189, (296)
train_y = RSS_value[200:,:]
test_x = receiver_position[0:200,:]
test_y = RSS_value[0:200,:]
...
num_inducing_choice = [i for i in range(math.floor(train_x.size(0) / 4),train_x.size(0)-1, 5)] # time:19
